...
__version__ = (2016, 7, 31, 4, 42, 22, 6)
...
class SqlParser(Parser):
    ...
    def _group_specification_(self):
        ...
        self._token('FOR')
        self._token('TYPE')
        self._user_defined_type_()

    @graken()
    def _user_defined_type_(self):
    ...
    def _array_specification_(self):
        self._collection_type_constructor_()
        self._left_bracket_or_trigraph_()
        self._unsigned_integer_()
        self._right_bracket_or_trigraph_()

    @graken()
    def _collection_type_constructor_(self):
        self._token('ARRAY')
    ...
    def _array_concatenation_(self):
        ...
        self._array_value_expression_2_()
    ...
    @graken()
    def _array_value_expression_2_(self):
        self._array_value_expression_()
    ...
    def _overlaps_predicate_(self):
        self._row_value_expression_1_()
        self._token('OVERLAPS')
        self._row_value_expression_2_()

    @graken()
    def _row_value_expression_1_(self):
        self._row_value_expression_()

    @graken()
    def _row_value_expression_2_(self):
        self._row_value_expression_()
    ...
    def _distinct_predicate_(self):
        self._row_value_expression_3_()
        self._token('IS')
        self._token('DISTINCT')
        self._token('FROM')
        self._row_value_expression_4_()

    @graken()
    def _row_value_expression_3_(self):
        self._row_value_expression_()

    @graken()
    def _row_value_expression_4_(self):
        self._row_value_expression_()
    ...
    def _sql_schema_definition_statement_(self):
        with self._choice():
            ...
            with self._option():
                self._sql_server_module_definition_()
            self._error('no available options')
    ...
    def _translation_source_(self):
        with self._choice():
            with self._option():
                self._existing_translation_name_()
            with self._option():
                self._translation_routine_()
            self._error('no available options')

    @graken()
    def _existing_translation_name_(self):
        self._translation_name_()

    @graken()
    def _translation_routine_(self):
    ...
    def _alter_routine_statement_(self):
        ...
        self._alter_routine_behaviour_()
    ...
    @graken()
    def _alter_routine_behaviour_(self):
        self._token('RESTRICT')
    ...
    def _sql_control_statement_(self):
        with self._choice():
            ...
            with self._option():
                self._compound_statement_()
            with self._option():
                self._case_statement_()
            with self._option():
                self._if_statement_()
            with self._option():
                self._iterate_statement_()
            with self._option():
                self._leave_statement_()
            with self._option():
                self._loop_statement_()
            with self._option():
                self._while_statement_()
            with self._option():
                self._repeat_statement_()
            with self._option():
    ...
    def _sql_diagnostics_statement_(self):
        with self._choice():
            ...
            with self._option():
                self._signal_statement_()
            with self._option():
                self._resignal_statement_()
            self._error('no available options')
    ...
    def _condition_information_item_name_(self):
        with self._choice():
            ...
            with self._option():
                self._token('CONDITION_IDENTIFIER')
            with self._option():
            ...
            self._error('expecting one of: CATALOG_NAME CLASS_ORIGIN COLUMN_NAME CONDITION_IDENTIFIER CONDITION_NUMBER CONNECTION_NAME CONSTRAINT_CATALOG CONSTRAINT_NAME CONSTRAINT_SCHEMA CURSOR_NAME MESSAGE_LENGTH MESSAGE_OCTET_LENGTH MESSAGE_TEXT PARAMETER_MODE PARAMETER_NAME PARAMETER_ORDINAL_POSITION RETURNED_SQLSTATE ROUTINE_CATALOG ROUTINE_NAME ROUTINE_SCHEMA SCHEMA_NAME SERVER_NAME SPECIFIC_NAME SUBCLASS_ORIGIN TABLE_NAME TRIGGER_CATALOG TRIGGER_NAME TRIGGER_SCHEMA')

    @graken()
    def _assignment_statement_(self):
        self._token('SET')
        self._assignment_target_()
        self._equals_operator_()
        self._assignment_source_()

    @graken()
    def _assignment_target_(self):
        with self._choice():
            with self._option():
                self._target_specification_()
            with self._option():
                self._modified_field_reference_()
            with self._option():
                self._mutator_reference_()
            self._error('no available options')

    @graken()
    def _sql_variable_reference_(self):
        self._basic_identifier_chain_()

    @graken()
    def _modified_field_reference_(self):
        self._modified_field_target_()
        self._period_()
        self._field_name_()

    @graken()
    def _modified_field_target_(self):
        with self._choice():
            with self._option():
                self._target_specification_()
            with self._option():
    ...
    @graken()
    def _mutator_reference_(self):
        self._mutated_target_specification_()
        self._period_()
        self._method_name_()

    @graken()
    def _mutated_target_specification_(self):
        with self._choice():
            with self._option():
                self._target_specification_()
            with self._option():
    ...
    @graken()
    def _assignment_source_(self):
        with self._choice():
            with self._option():
                self._value_expression_()
            with self._option():
                self._contextually_typed_source_()
            self._error('no available options')

    @graken()
    def _contextually_typed_source_(self):
        with self._choice():
            with self._option():
                self._implicitly_typed_value_specification_()
            with self._option():
    ...
    @graken()
    def _compound_statement_(self):
        with self._optional():
            self._beginning_label_()
            self._colon_()
        self._token('BEGIN')
        with self._optional():
            with self._optional():
            ...
            self._token('ATOMIC')
        with self._optional():
            self._local_declaration_list_()
        with self._optional():
            self._local_cursor_declaration_list_()
        with self._optional():
            self._local_handler_declaration_list_()
        with self._optional():
            self._sql_statement_list_()
        self._token('END')
        with self._optional():
            self._ending_label_()

    @graken()
    def _beginning_label_(self):
        self._statement_label_()

    @graken()
    def _statement_label_(self):
        self._identifier_()

    @graken()
    def _local_declaration_list_(self):

        def block0():
            self._terminated_local_declaration_()
        self._positive_closure(block0)

    @graken()
    def _terminated_local_declaration_(self):
        self._local_declaration_()
        self._semicolon_()

    @graken()
    def _local_declaration_(self):
        with self._choice():
            with self._option():
                self._sql_variable_declaration_()
            with self._option():
                self._condition_declaration_()
            self._error('no available options')

    @graken()
    def _sql_variable_declaration_(self):
        self._token('DECLARE')
        self._sql_variable_name_list_()
        self._data_type_()
        with self._optional():
            self._default_clause_()

    @graken()
    def _sql_variable_name_list_(self):
        self._sql_variable_name_()
        with self._optional():
    ...
    @graken()
    def _sql_variable_name_(self):
        self._identifier_()

    @graken()
    def _condition_declaration_(self):
        self._token('DECLARE')
        self._condition_name_()
        self._token('CONDITION')
        with self._optional():
            self._token('FOR')
            self._sqlstate_value_()

    @graken()
    def _condition_name_(self):
        self._identifier_()

    @graken()
    def _sqlstate_value_(self):
    ...
    @graken()
    def _local_cursor_declaration_list_(self):

        def block0():
            self._terminated_local_cursor_declaration_()
        self._positive_closure(block0)

    @graken()
    def _terminated_local_cursor_declaration_(self):
        self._declare_cursor_()
        self._semicolon_()

    @graken()
    def _local_handler_declaration_list_(self):

        def block0():
            self._terminated_local_handler_declaration_()
        self._positive_closure(block0)

    @graken()
    def _terminated_local_handler_declaration_(self):
        self._handler_declaration_()
        self._semicolon_()

    @graken()
    def _handler_declaration_(self):
        self._token('DECLARE')
        self._handler_type_()
        self._token('HANDLER')
        self._token('FOR')
        self._condition_value_list_()
        self._handler_action_()

    @graken()
    def _handler_type_(self):
        with self._choice():
            with self._option():
            ...
            with self._option():
                self._token('UNDO')
            self._error('expecting one of: CONTINUE EXIT UNDO')

    @graken()
    def _condition_value_list_(self):
        self._condition_value_()
        with self._optional():
    ...
    def _condition_value_(self):
        with self._choice():
            ...
            with self._option():
                self._condition_name_()
            with self._option():
                self._token('SQLEXCEPTION')
            with self._option():
                self._token('SQLWARNING')
            with self._option():
                self._token('NOT')
                self._token('FOUND')
            self._error('expecting one of: NOT SQLEXCEPTION SQLWARNING')

    @graken()
    def _handler_action_(self):
        self._sql_procedure_statement_()

    @graken()
    def _sql_statement_list_(self):

        def block0():
            self._terminated_sql_statement_()
        self._positive_closure(block0)

    @graken()
    def _terminated_sql_statement_(self):
        self._sql_procedure_statement_()
        self._semicolon_()

    @graken()
    def _ending_label_(self):
        self._statement_label_()

    @graken()
    def _case_statement_(self):
        with self._choice():
            with self._option():
                self._simple_case_statement_()
            with self._option():
                self._searched_case_statement_()
            self._error('no available options')

    @graken()
    def _simple_case_statement_(self):
        self._token('CASE')
        self._simple_case_operand_1_()

        def block0():
            self._simple_case_statement_when_clause_()
        self._positive_closure(block0)
        with self._optional():
            self._case_statement_else_clause_()
        self._token('END')
        self._token('CASE')

    @graken()
    def _simple_case_operand_1_(self):
        self._value_expression_()

    @graken()
    def _simple_case_statement_when_clause_(self):
        self._token('WHEN')
        self._simple_case_operand_2_()
        self._token('THEN')
        self._sql_statement_list_()

    @graken()
    def _simple_case_operand_2_(self):
        self._value_expression_()

    @graken()
    def _case_statement_else_clause_(self):
        self._token('ELSE')
        self._sql_statement_list_()

    @graken()
    def _searched_case_statement_(self):
        self._token('CASE')

        def block0():
            self._searched_case_statement_when_clause_()
        self._positive_closure(block0)
        with self._optional():
            self._case_statement_else_clause_()
        self._token('END')
    ...
    @graken()
    def _searched_case_statement_when_clause_(self):
        self._token('WHEN')
        self._search_condition_()
        self._token('THEN')
        self._sql_statement_list_()
    ...
    def _if_statement_(self):
        self._token('IF')
        self._search_condition_()
        self._if_statement_then_clause_()
        with self._optional():

            def block0():
                self._if_statement_elseif_clause_()
            self._positive_closure(block0)
        with self._optional():
            self._if_statement_else_clause_()
        self._token('END')
        self._token('IF')

    @graken()
    def _if_statement_then_clause_(self):
        self._token('THEN')
        self._sql_statement_list_()

    @graken()
    def _if_statement_elseif_clause_(self):
        self._token('ELSEIF')
        self._search_condition_()
        self._token('THEN')
        self._sql_statement_list_()
    ...
    @graken()
    def _if_statement_else_clause_(self):
        self._token('ELSE')
        self._sql_statement_list_()

    @graken()
    def _iterate_statement_(self):
        self._token('ITERATE')
        self._statement_label_()

    @graken()
    def _leave_statement_(self):
        self._token('LEAVE')
        self._statement_label_()
    ...
    @graken()
    def _for_loop_variable_name_(self):
        self._identifier_()

    @graken()
    def _signal_statement_(self):
        self._token('SIGNAL')
        self._signal_value_()
        with self._optional():
            self._set_signal_information_()

    @graken()
    def _signal_value_(self):
        with self._choice():
            with self._option():
                self._condition_name_()
            with self._option():
    ...
    @graken()
    def _set_signal_information_(self):
        self._token('SET')
        self._signal_information_item_list_()

    @graken()
    def _signal_information_item_list_(self):
        self._signal_information_item_()
        with self._optional():
    ...
    @graken()
    def _signal_information_item_(self):
        self._condition_information_item_name_()
        self._equals_operator_()
        self._simple_value_specification_()

    @graken()
    def _resignal_statement_(self):
        self._token('RESIGNAL')
        with self._optional():
            self._signal_value_()
        with self._optional():
            self._set_signal_information_()
    ...
    @graken()
    def _sql_server_module_definition_(self):
        self._token('CREATE')
        self._token('MODULE')
        self._sql_server_module_name_()
        with self._optional():
            self._sql_server_module_character_set_specification_()
        with self._optional():
            self._sql_server_module_schema_clause_()
        with self._optional():
            self._sql_server_module_path_specification_()
        with self._optional():
            self._temporary_table_declaration_()

        def block0():
            self._sql_server_module_contents_()
        self._positive_closure(block0)
        self._token('END')
        self._token('MODULE')

    @graken()
    def _sql_server_module_name_(self):
        self._schema_qualified_name_()

    @graken()
    def _sql_server_module_character_set_specification_(self):
        self._token('NAMES')
        self._token('ARE')
        self._character_set_specification_()

    @graken()
    def _sql_server_module_schema_clause_(self):
        self._token('SCHEMA')
        self._default_schema_name_()

    @graken()
    def _default_schema_name_(self):
        self._schema_name_()

    @graken()
    def _sql_server_module_path_specification_(self):
        self._path_specification_()

    @graken()
    def _sql_server_module_contents_(self):
        self._sql_invoked_routine_()
        self._semicolon_()

    @graken()
    def _module_routine_(self):
        with self._choice():
            with self._option():
                self._module_procedure_()
            with self._option():
                self._module_function_()
            self._error('no available options')

    @graken()
    def _module_procedure_(self):
        with self._optional():
            self._token('DECLARE')
        self._sql_invoked_procedure_()

    @graken()
    def _module_function_(self):
        with self._optional():
            self._token('DECLARE')
        self._sql_invoked_function_()

    @graken()
    def _drop_module_statement_(self):
        self._token('DROP')
        self._token('MODULE')
        self._sql_server_module_name_()
        self._drop_behavior_()
...
class SqlSemantics(object):
    ...
    def user_defined_type(self, ast):
        return ast

    def user_defined_type_name(self, ast):
        return ast

    def schema_qualified_type_name(self, ast):
        return ast
    ...
    def reference_scope_check_action(self, ast):
        return ast
    ...
    def collection_type_constructor(self, ast):
        return ast
    ...
    def array_value_expression_2(self, ast):
        return ast
    ...
    def octet_match_value(self, ast):
        return ast
    ...
    def row_value_expression_1(self, ast):
        return ast

    def row_value_expression_2(self, ast):
        return ast
    ...
    def row_value_expression_3(self, ast):
        return ast

    def row_value_expression_4(self, ast):
        return ast
    ...
    def existing_translation_name(self, ast):
        return ast

    def translation_routine(self, ast):
        return ast
    ...
    def old_values_correlation_name(self, ast):
        return ast

    def new_values_correlation_name(self, ast):
        return ast

    def old_values_table_alias(self, ast):
        return ast

    def new_values_table_alias(self, ast):
        return ast
    ...
    def maximum_dynamic_result_sets(self, ast):
        return ast
    ...
    def alter_routine_behaviour(self, ast):
        return ast
    ...
    def assignment_target(self, ast):
        return ast

    def sql_variable_reference(self, ast):
        return ast

    def modified_field_reference(self, ast):
        return ast

    def modified_field_target(self, ast):
        return ast

    def mutator_reference(self, ast):
        return ast

    def mutated_target_specification(self, ast):
        return ast

    def assignment_source(self, ast):
        return ast

    def contextually_typed_source(self, ast):
        return ast

    def compound_statement(self, ast):
        return ast

    def beginning_label(self, ast):
        return ast

    def statement_label(self, ast):
        return ast

    def local_declaration_list(self, ast):
        return ast

    def terminated_local_declaration(self, ast):
        return ast

    def local_declaration(self, ast):
        return ast

    def sql_variable_declaration(self, ast):
        return ast

    def sql_variable_name_list(self, ast):
        return ast

    def sql_variable_name(self, ast):
        return ast

    def condition_declaration(self, ast):
        return ast

    def condition_name(self, ast):
        return ast

    def sqlstate_value(self, ast):
        return ast

    def local_cursor_declaration_list(self, ast):
        return ast

    def terminated_local_cursor_declaration(self, ast):
        return ast

    def local_handler_declaration_list(self, ast):
        return ast

    def terminated_local_handler_declaration(self, ast):
        return ast

    def handler_declaration(self, ast):
        return ast

    def handler_type(self, ast):
        return ast

    def condition_value_list(self, ast):
        return ast

    def condition_value(self, ast):
        return ast

    def handler_action(self, ast):
        return ast

    def sql_statement_list(self, ast):
        return ast

    def terminated_sql_statement(self, ast):
        return ast

    def ending_label(self, ast):
        return ast

    def case_statement(self, ast):
        return ast

    def simple_case_statement(self, ast):
        return ast

    def simple_case_operand_1(self, ast):
        return ast

    def simple_case_statement_when_clause(self, ast):
        return ast

    def simple_case_operand_2(self, ast):
        return ast

    def case_statement_else_clause(self, ast):
        return ast

    def searched_case_statement(self, ast):
        return ast

    def searched_case_statement_when_clause(self, ast):
        return ast

    def if_statement(self, ast):
        return ast

    def if_statement_then_clause(self, ast):
        return ast

    def if_statement_elseif_clause(self, ast):
        return ast

    def if_statement_else_clause(self, ast):
        return ast

    def iterate_statement(self, ast):
        return ast

    def leave_statement(self, ast):
        return ast
    ...
    def repeat_statement(self, ast):
        return ast

    def for_statement(self, ast):
        return ast

    def for_loop_variable_name(self, ast):
        return ast

    def signal_statement(self, ast):
        return ast

    def signal_value(self, ast):
        return ast

    def set_signal_information(self, ast):
        return ast

    def signal_information_item_list(self, ast):
        return ast

    def signal_information_item(self, ast):
        return ast

    def resignal_statement(self, ast):
        return ast

    def sql_server_module_definition(self, ast):
        return ast

    def sql_server_module_name(self, ast):
        return ast

    def sql_server_module_character_set_specification(self, ast):
        return ast

    def sql_server_module_schema_clause(self, ast):
        return ast

    def default_schema_name(self, ast):
        return ast

    def sql_server_module_path_specification(self, ast):
        return ast

    def sql_server_module_contents(self, ast):
        return ast

    def module_routine(self, ast):
        return ast

    def module_procedure(self, ast):
        return ast

    def module_function(self, ast):
        return ast

    def drop_module_statement(self, ast):
        return ast
